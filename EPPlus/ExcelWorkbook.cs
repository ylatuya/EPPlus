			...
			get
			{
				if (_stylesXml == null)
				{
					...
					else
					{
						...
						_package.Workbook.Part.CreateRelationship(PackUriHelperMonoSafe.GetRelativeUri(WorkbookUri, StylesUri), TargetMode.Internal, ExcelPackage.schemaRelationships + "/styles",
