    ...
    public class ExcelChart : ExcelDrawing
    {
       ...
       private void CreateNewChart(ExcelDrawings drawings, eChartType type, ExcelChart topChart)
       {
           if (topChart == null)
           {
               ...
               PackageRelationship chartRelation = drawings.Part.CreateRelationship(PackUriHelperMonoSafe.GetRelativeUri(drawings.UriDrawing, UriChart), TargetMode.Internal, ExcelPackage.schemaRelationships + "/chart",
